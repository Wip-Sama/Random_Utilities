...
local function create_inserter_item(suffix, tint, tier, stack, filter, long)
    ...
    item.order = string.sub(letters, tier) .. "[inserter-mk" .. tostring(tier) .. "]-" .. tostring(count) ..
    "[" .. name .. "]"
...
local function create_inserter_recipe(suffix, tier, ing, stack, filter, long)
    ...
    local to_add = {
        ((tier > 1) and { "ru-mk" ..
        tier - 1 ..
        (long and "-long" or "") .. (stack and "-stack" or "") .. (filter and "-filtered" or "") .. "-inserter", 1 } or nil),
    }
...
local function create_inserter_entity(suffix, tint, tier, stack, filter, long)
    ...
    entity.hand_base_picture = {
        layers = {
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-base.png",
                priority = "extra-high",
                width = 8,
                height = 34,
                hr_version = {
            ...
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-base-mask.png",
                priority = "extra-high",
                width = 8,
                height = 34,
                tint = tint,
    ...
    entity.hand_closed_picture = {
        layers = {
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-closed.png",
                priority = "extra-high",
                width = 24,
                height = 41,
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-closed.png",
                    priority = "extra-high",
            ...
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-closed-mask.png",
                priority = "extra-high",
                width = 24,
                height = 41,
                tint = tint,
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-closed-mask.png",
                    priority = "extra-high",
                    width = stack and 100 or 72,
                    height = 164,
                    scale = 0.25,
    ...
    entity.hand_open_picture = {
        layers = {
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-open.png",
                priority = "extra-high",
                width = 32,
                height = 41,
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-open.png",
                    priority = "extra-high",
            ...
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-open-mask.png",
                priority = "extra-high",
                width = 32,
                height = 41,
                tint = tint,
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-open-mask.png",
                    priority = "extra-high",
                    width = stack and 130 or 72,
                    height = 164,
                    scale = 0.25,
    ...
    entity.platform_picture = {
        sheets = {
            ...
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-platform.png",
                priority = "extra-high",
                width = 46,
                height = 46,
                shift = { 0.09375, 0 },
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-platform.png",
                    priority = "extra-high",
                    width = 105,
                    height = 79,
                    shift = util.by_pixel(1.5, 7.5 - 1),
            ...
            {
                filename = "__Random_Utilities__/graphics/entity/" ..
                inserter_type .. "inserter/" .. inserter_type .. "inserter-platform-mask.png",
                priority = "extra-high",
                width = 46,
                height = 46,
                shift = { 0.09375, 0 },
                ...
                hr_version = {
                    filename = "__Random_Utilities__/graphics/entity/" ..
                    inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-platform-mask.png",
                    priority = "extra-high",
                    width = 105,
                    height = 79,
                    shift = util.by_pixel(1.5, 7.5 - 1),
    ...
    if stack == true then
        entity.hand_closed_shadow = {
            ...
            inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-closed-shadow.png",
            priority = "extra-high",
            width = 24,
            height = 41,
            hr_version = {
                filename = "__base__/graphics/entity/" ..
                inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-closed-shadow.png",
                priority = "extra-high",
                width = 100,
                height = 164,
                scale = 0.25
        ...
        entity.hand_open_shadow = {
            filename = "__base__/graphics/entity/" ..
            inserter_type .. "inserter/" .. inserter_type .. "inserter-hand-open-shadow.png",
            priority = "extra-high",
            width = 32,
            height = 41,
            hr_version = {
                filename = "__base__/graphics/entity/" ..
                inserter_type .. "inserter/hr-" .. inserter_type .. "inserter-hand-open-shadow.png",
                priority = "extra-high",
                width = 130,
                height = 164,
                scale = 0.25
