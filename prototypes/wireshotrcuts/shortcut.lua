...
{
  {
      ...
      icon =
      {
        filename = "__Random_Utilities__/graphics/icons/red-wire-x32.png",
      ...
      small_icon =
      {
        filename = "__Random_Utilities__/graphics/icons/red-wire-x24.png",
        priority = "extra-high-no-scale",
        size = 24,
        scale = 1,
        flags = {"icon"}
  ...
  },
  {
      ...
      icon =
      {
        filename = "__Random_Utilities__/graphics/icons/green-wire-x32.png",
        priority = "extra-high-no-scale",
        size = 32,
        scale = 1,
        flags = {"icon"}
      ...
      small_icon =
      {
        filename = "__Random_Utilities__/graphics/icons/green-wire-x24.png",
        priority = "extra-high-no-scale",
        size = 24,
        scale = 1,
        flags = {"icon"}
  ...
  },
  {
      ...
      icon =
      {
        filename = "__Random_Utilities__/graphics/icons/copper-wire-x32.png",
        priority = "extra-high-no-scale",
        size = 32,
        scale = 1,
        flags = {"icon"}
      ...
      small_icon =
      {
        filename = "__Random_Utilities__/graphics/icons/copper-wire-x24.png",
        priority = "extra-high-no-scale",
        size = 24,
        scale = 1,
        flags = {"icon"}
